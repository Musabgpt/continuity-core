...
class ContinuityTests(unittest.TestCase):
    ...
    def test_init_event_next_handoff(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            s=json.loads((root/"continuity/state.json").read_text(encoding="utf-8")); self.assertEqual(s["decisions"],["Use tests"])
    ...
    def test_json_handoff_is_deterministic_and_omits_timestamps(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertEqual(payload["next_action"],"install sdk")
